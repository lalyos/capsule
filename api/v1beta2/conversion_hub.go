...
func (in *Tenant) ConvertFrom(raw conversion.Hub) error {
	...
	in.Spec.IngressOptions = IngressOptions{
		HostnameCollisionScope: HostnameCollisionScope(src.Spec.IngressOptions.HostnameCollisionScope),
		AllowWildcardHostnames: func() bool {
	...
	in.Spec.NetworkPolicies.Items = src.Spec.NetworkPolicies.Items
	in.Spec.LimitRanges.Items = src.Spec.LimitRanges.Items
	in.Spec.ResourceQuota = ResourceQuotaSpec{
